"""Generate 30/6 report directly — bypass CLI arg bug.
Uses load_hk_tickers + load_us_tickers from ticker_loader.
DSA_REPORT_DATE_OVERRIDE=2026-06-30 env var tells analyze() to write to 30/6.
"""
import json
import os
import sys
...
os.environ["DSA_REPORT_DATE_OVERRIDE"] = "2026-06-30"
